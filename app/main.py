...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        # MongoDB + Beanie init
        db = mongo_connection.mongo_connection.connect()  # returns MotorDatabase
...
if __name__ == "__main__":
    ...
    logger.info(f"Starting server on {settings.HOST}:{settings.RECEIVE_SERVICE_PORT}")
    uvicorn.run(
        "app.main:app",
        host=settings.HOST,
        port=settings.RECEIVE_SERVICE_PORT,
