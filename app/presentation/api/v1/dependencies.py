...
from app.infrastructure.repositories.mysql_repo import MySQLPracticeRepository
...
@lru_cache()
def get_mongo_practice_repository() -> MongoRepository:
    """Get instance of MongoRepository."""
...
def get_register_practice_service() -> PracticeService:
    ...
    return PracticeService(
        mysql_repo=get_mysql_practice_repository(),
        mongo_repo=get_mongo_practice_repository(),
